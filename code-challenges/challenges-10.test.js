...
const createServer = () => {
  ...
  let faveFoods = ['tacos', 'pizza', 'spaghetti carbonara', 'waffles', 'prime rib', 'enchiladas', 'tamales'];
  const express = require('express');
  const app = express();

  app.get('/hello', handleGreeting);
  app.get('/aboutme', handleBio);
  ...
  function handleBio(req, res) {
    res.send('My name is Mike, I\'m a full stack software developer. I grew up in Reno, NV. I\'ve lived in Seattle for the last 12 years. I love to ski, play golf, and ride bikes.');
  }

  function handleFoods(req, res) {
    res.send(faveFoods);
  }
