...
const templateWithJQuery = () => {
  // Solution code here...
  let starWarsPeeps = $('.template').clone();

 

  starWarsPeeps.find('h2').text(starWarsPeople.name);
  starWarsPeeps.find('h3').text(starWarsPeople.height);
  starWarsPeeps.find('p').text(starWarsPeople.eye_color);

  $('main').append(starWarsPeeps);
};
...
const howMuchPencil = (str) => {
  ...
  result.forEach(result=>newString(result));
